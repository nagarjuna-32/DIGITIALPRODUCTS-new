...
function LoginContent() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Send a mock token with random hash to simulate Google Auth payload on backend
    ...
    <div className="flex-grow flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 relative grid-dots">
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-zinc-500 mt-1">Unlock your digital category purchases instantly</p>
        </div>
        ...
        <div className="p-8 rounded-3xl border border-white/5 bg-[#09090b]/45 backdrop-blur-md space-y-5">
          ...
          <p className="text-center text-xs text-zinc-500 pt-2">
            ...
            <Link href="/auth/register" className="text-brand-purple hover:underline font-bold transition-all">
              Sign up free
            </Link>
          </p>
